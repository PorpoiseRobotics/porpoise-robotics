...
void drive(int leftSpeed, int rightSpeed) {
  ledcWrite(FRONT_LEFT_A,  leftSpeed  > 0 ?  leftSpeed  : 0);
  ledcWrite(FRONT_LEFT_B,  leftSpeed  < 0 ? -leftSpeed  : 0);
  ledcWrite(REAR_LEFT_A,   leftSpeed  > 0 ?  leftSpeed  : 0);
  ledcWrite(REAR_LEFT_B,   leftSpeed  < 0 ? -leftSpeed  : 0);
  ledcWrite(FRONT_RIGHT_A, rightSpeed > 0 ?  rightSpeed : 0);
  ledcWrite(FRONT_RIGHT_B, rightSpeed < 0 ? -rightSpeed : 0);
  ledcWrite(REAR_RIGHT_A,  rightSpeed > 0 ?  rightSpeed : 0);
  ledcWrite(REAR_RIGHT_B,  rightSpeed < 0 ? -rightSpeed : 0);
}
